...
if(slam_test_CONFIG_INCLUDED)
  return()
endif()
set(slam_test_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(slam_test_SOURCE_PREFIX /home/ubuntu/catkin_ws/src/slam_test)
  set(slam_test_DEVEL_PREFIX /home/ubuntu/catkin_ws/devel)
  set(slam_test_INSTALL_PREFIX "")
  set(slam_test_PREFIX ${slam_test_DEVEL_PREFIX})
else()
  set(slam_test_SOURCE_PREFIX "")
  set(slam_test_DEVEL_PREFIX "")
  set(slam_test_INSTALL_PREFIX /home/ubuntu/catkin_ws/install)
  set(slam_test_PREFIX ${slam_test_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'slam_test' is deprecated")
...
set(slam_test_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/ubuntu/catkin_ws/src/slam_test/include;/usr/include/pcl-1.7;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/vtk-6.2;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/jsoncpp;/usr/include/x86_64-linux-gnu;/usr/include/freetype2;/usr/include/x86_64-linux-gnu/freetype2;/usr/include/tcl;/usr/include/python2.7;/usr/include/hdf5/openmpi;/usr/include/libxml2 " STREQUAL " ")
  set(slam_test_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/catkin_ws/src/slam_test/include;/usr/include/pcl-1.7;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/vtk-6.2;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/jsoncpp;/usr/include/x86_64-linux-gnu;/usr/include/freetype2;/usr/include/x86_64-linux-gnu/freetype2;/usr/include/tcl;/usr/include/python2.7;/usr/include/hdf5/openmpi;/usr/include/libxml2")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${slam_test_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'slam_test' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'slam_test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/catkin_ws/src/slam_test/${idir}'.  ${_report}")
    endif()
    _list_append_unique(slam_test_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND slam_test_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND slam_test_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT slam_test_NUM_DUMMY_TARGETS)
      set(slam_test_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::slam_test::wrapped-linker-option${slam_test_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR slam_test_NUM_DUMMY_TARGETS "${slam_test_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::slam_test::wrapped-linker-option${slam_test_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND slam_test_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(slam_test_LIBRARY_DIRS ${lib_path})
      list(APPEND slam_test_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'slam_test'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND slam_test_LIBRARIES ${lib})
    endif()
  endif()
...
set(slam_test_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${slam_test_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 slam_test_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${slam_test_dep}_FOUND)
      find_package(${slam_test_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${slam_test_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(slam_test_INCLUDE_DIRS ${${slam_test_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(slam_test_LIBRARIES ${slam_test_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${slam_test_dep}_LIBRARIES})
  _list_append_deduplicate(slam_test_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(slam_test_LIBRARIES ${slam_test_LIBRARIES})

  _list_append_unique(slam_test_LIBRARY_DIRS ${${slam_test_dep}_LIBRARY_DIRS})
  list(APPEND slam_test_EXPORTED_TARGETS ${${slam_test_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${slam_test_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
